...
export const DUEL_CATEGORIES = [
  ...
  { id: 'apocalipsis', name: 'Apokalips', nameES: 'Apocalypse', nameFR: 'Apocalypse', icon: '🔥' },
  ...
  { id: 'reyes', name: 'Wa yo ak Pwofèt yo', nameES: 'Rois et Prophètes', nameFR: 'Rois et Prophètes', icon: '👑' },
  ...
  { id: 'mujeres', name: 'Fanm nan Bib la', nameES: 'Mujeres de la Bible', nameFR: 'Femmes de la Bible', icon: '👩' },
