...
export const DUEL_CATEGORIES = [
  ...
  { id: 'hechos', name: 'Travay Apòt yo', nameFR: "Actes des Apôtres", icon: '🎬' },
  ...
  { id: 'vida-cristiana', name: 'Lavi Kretyen', nameFR: 'Vie Chrétienne', icon: '✝️' },
  { id: 'iglesia', name: 'Legliz', nameFR: 'Église', icon: '⛪' },
  { id: 'espiritu-santo', name: 'Sentespri', nameFR: 'Saint-Esprit', icon: '🕊️' },
  { id: 'escatologia', name: 'Eskatoloji', nameFR: 'Eschatologie', icon: '🎺' },
  { id: 'mision', name: 'Misyon', nameFR: 'Mission', icon: '🌍' },
  { id: 'ley-moral', name: 'Lwa Moral', nameFR: 'Loi Morale', icon: '📜' },
  { id: 'nuevo-testamento', name: 'Nouvo Testaman (Jeneral)', nameFR: 'Nouveau Testament (Général)', icon: '📖' },
  { id: 'tabernakulo', name: 'Tabènak ak Tanp', nameFR: 'Tabernacle et Temple', icon: '⛺' },
  { id: 'lideres', name: 'Lidè nan Bib la', nameFR: 'Leaders Bibliques', icon: '👥' },
  { id: 'viajes-pablo', name: 'Vwayaj Pòl yo', nameFR: 'Voyages de Paul', icon: '⛵' },
  { id: 'cultura', name: 'Kilti ak Sosyete', nameFR: 'Culture et Société', icon: '🏺' },
  { id: 'oracion', name: 'Lapriyè', nameFR: 'Prière', icon: '🙏' },
  { id: 'at-general', name: 'Ansyen Testaman (Jeneral)', nameFR: 'Ancien Testament (Général)', icon: '📜' },
  { id: 'intertestamentario', name: 'Peryòd Entètestamantè', nameFR: 'Période Intertestamentaire', icon: '⏳' },
  { id: 'guerras', name: 'Lagè ak Batay', nameFR: 'Guerres et Batailles', icon: '⚔️' },
];
